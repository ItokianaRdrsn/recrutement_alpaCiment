...
--
-- Name: critere_offre; Type: TABLE; Schema: public; Owner: postgres
--

CREATE TABLE public.critere_offre (
    id_critere_offre bigint NOT NULL,
    id_offre bigint NOT NULL,
    libelle character varying(150) NOT NULL,
    type_critere character varying(30) DEFAULT 'autre'::character varying NOT NULL,
    valeur_min character varying(100),
    valeur_max character varying(100),
    valeur_attendue character varying(200),
    unite character varying(50),
    obligatoire boolean DEFAULT true NOT NULL,
    ordre integer DEFAULT 1 NOT NULL,
    created_at timestamp(0) with time zone,
    updated_at timestamp(0) with time zone,
    CONSTRAINT chk_critere_offre_ordre CHECK ((ordre > 0)),
    CONSTRAINT chk_critere_offre_type CHECK (((type_critere)::text = ANY ((ARRAY['experience'::character varying, 'age'::character varying, 'permis'::character varying, 'date'::character varying, 'formation'::character varying, 'autre'::character varying])::text[]))),
    CONSTRAINT chk_critere_offre_valeur CHECK (((valeur_min IS NOT NULL) OR (valeur_max IS NOT NULL) OR (valeur_attendue IS NOT NULL)))
);


ALTER TABLE public.critere_offre OWNER TO postgres;

--
-- Name: critere_offre_id_critere_offre_seq; Type: SEQUENCE; Schema: public; Owner: postgres
--

CREATE SEQUENCE public.critere_offre_id_critere_offre_seq
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
    NO MAXVALUE
...
ALTER SEQUENCE public.critere_offre_id_critere_offre_seq OWNER TO postgres;

--
-- Name: critere_offre_id_critere_offre_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: postgres
--

ALTER SEQUENCE public.critere_offre_id_critere_offre_seq OWNED BY public.critere_offre.id_critere_offre;
...
--
-- Name: critere_offre id_critere_offre; Type: DEFAULT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.critere_offre ALTER COLUMN id_critere_offre SET DEFAULT nextval('public.critere_offre_id_critere_offre_seq'::regclass);
...
--
-- Data for Name: critere_offre; Type: TABLE DATA; Schema: public; Owner: postgres
--

COPY public.critere_offre (id_critere_offre, id_offre, libelle, type_critere, valeur_min, valeur_max, valeur_attendue, unite, obligatoire, ordre, created_at, updated_at) FROM stdin;
\.
...
1	Developpement Web	1	t	2026-08-25 07:56:24+03	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
2	Developpement Mobile	1	t	2026-08-25 07:56:24+03	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
3	Base de Donnees	1	f	\N	\N	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
4	Recrutement	2	t	2026-08-25 07:56:24+03	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
5	Formation	2	f	\N	\N	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
6	Comptabilite	3	t	2026-08-25 07:56:24+03	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
7	Tresorerie	3	f	\N	\N	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
8	Communication Digitale	4	t	2026-08-25 07:56:24+03	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
9	Relations Publiques	4	f	\N	\N	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
10	Ventes B2B	5	t	2026-08-25 07:56:24+03	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
\.
...
1	Developpeur Full Stack	1	Offre de recrutement pour le poste Developpeur Full Stack.	Antananarivo	1	2026-01-15	2026-03-15	2	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
2	Developpeur React Native	1	Offre de recrutement pour le poste Developpeur React Native.	Antananarivo	1	2026-02-01	2026-04-01	2	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
3	Data Engineer	1	Offre de recrutement pour le poste Data Engineer.	Antananarivo	1	2026-01-20	2026-03-20	2	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
4	Responsable Recrutement	2	Offre de recrutement pour le poste Responsable Recrutement.	Antananarivo	1	2026-01-10	2026-02-10	3	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
5	Comptable	3	Offre de recrutement pour le poste Comptable.	Antananarivo	1	2026-02-01	2026-04-01	1	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
6	Charge de Marketing Digital	4	Offre de recrutement pour le poste Charge de Marketing Digital.	Antananarivo	2	2026-01-25	2026-03-25	2	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
7	Commercial Senior	5	Offre de recrutement pour le poste Commercial Senior.	Antananarivo	1	2026-01-15	2026-03-15	2	2026-08-25 07:56:24+03	2026-08-25 07:56:24+03
\.
...
COPY public.profil_formation (id_profil_formation, id_offre, niveau_min, niveau_max, domaine, obligatoire, created_at) FROM stdin;
\.
...
COPY public.profil_offre (id_profil_offre, id_offre, description, created_at, updated_at) FROM stdin;
\.
...
COPY public.statut_offre (id_statut_offre, libelle, ordre_workflow) FROM stdin;
1	Brouillon	1
2	Publiee	2
3	Cloturee	3
\.
...
1	Administrateur RH	admin@alphaciment.local	admin	\N	$2y$12$Z9XLKa9wVfcG0fvuZzj8hu9d81HLFP.hJ67XB4hE6QAajdZRs7wtG	\N	2026-08-25 07:56:24	2026-08-25 07:56:24
\.


--
-- Name: critere_offre_id_critere_offre_seq; Type: SEQUENCE SET; Schema: public; Owner: postgres
--

SELECT pg_catalog.setval('public.critere_offre_id_critere_offre_seq', 1, false);
...
--
-- Name: critere_offre critere_offre_pkey; Type: CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.critere_offre
    ADD CONSTRAINT critere_offre_pkey PRIMARY KEY (id_critere_offre);
...
--
-- Name: idx_critere_offre_offre; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_critere_offre_offre ON public.critere_offre USING btree (id_offre);
...
--
-- Name: idx_profil_formation_offre; Type: INDEX; Schema: public; Owner: postgres
--

CREATE INDEX idx_profil_formation_offre ON public.profil_formation USING btree (id_offre);
...
--
-- Name: critere_offre critere_offre_id_offre_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.critere_offre
    ADD CONSTRAINT critere_offre_id_offre_foreign FOREIGN KEY (id_offre) REFERENCES public.offre(id_offre) ON DELETE CASCADE;
...
--
-- Name: profil_formation profil_formation_id_offre_foreign; Type: FK CONSTRAINT; Schema: public; Owner: postgres
--

ALTER TABLE ONLY public.profil_formation
    ADD CONSTRAINT profil_formation_id_offre_foreign FOREIGN KEY (id_offre) REFERENCES public.offre(id_offre) ON DELETE CASCADE;
